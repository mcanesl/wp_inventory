	    ...
	    <table class="list_items_table" class="display" width="100%">
			...
			foreach ($current_asignations as $key => $value) {
				...
				<tr>
				  ...
				  <td>
				      <a href="return_item.php?id_item='.$value->id_item.'&id_asignation='.$value->id_asignation.'" target="operations_frame"><img src="images/outgoing-2.png" width="16px" height="16px"></img></a>
				  </td>
				</tr>';
			}
			echo '	
	    ...
	    <table class="list_items_table" class="display" width="100%">
			...
			foreach ($closed_asignations as $key => $value) {
				...
				<tr>
				  ...
				  <td>
				      <a href="item_details.php?id_item='.$value->id_item.'", target="operations_frae"><img src="images/zoom-in-2.png" width="16px" height="16px"></img></a>
				  </td>
				</tr>';
			}
			echo '	
